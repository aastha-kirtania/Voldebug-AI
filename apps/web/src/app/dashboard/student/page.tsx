...
export default function StudentDashboardPage() {
  ...
  const AVATAR_MAP: Record<
    string,
    { emoji?: string; image?: string; name: string }
  > = {
  ...
  const mascotGreeting = useMemo(() => {
    const greetings = [
      isHindi
        ? "अरे दोस्त! आज हम क्या नया सीखेंगे? 🌟"
        : "Hey adventurer! What magical things will we explore today? 🌟",
      isHindi
        ? "गलतियां केवल यह दर्शाती हैं कि आप कोशिश कर रहे हैं! 🧠"
        : "Mistakes just show that you are trying! Let's grow together! 🧠",
      isHindi
        ? "आप बहुत अच्छा कर रहे हैं! चलो क्लास का रिकॉर्ड तोड़ते हैं! 🚀"
        : "You are doing fantastic! Let's beat our high scores today! 🚀",
      isHindi
        ? "एआई टूल्स हमारी सुपरपावर हैं! चलो जादू शुरू करें! ⚡"
        : "AI tools are our superpowers! Let's create some magic! ⚡",
    ];
  ...
  const kidsWorlds = [
    {
      name: isHindi ? "कक्षा के मिशन" : "Classroom Quests",
      subject: "Missions",
      icon: "🏫",
      desc: isHindi
        ? "होमवर्क पूरा करें, काम सबमिट करें और शिक्षकों से XP अर्जित करें!"
        : "Complete assignments, submit work, and earn XP from teachers!",
      color: "from-amber-300 via-yellow-400 to-orange-500",
      shadow: "shadow-amber-200/50 border-amber-300",
      path: "/dashboard/classroom",
    },
    {
      name: isHindi ? "एआई टूल्स ब्रह्मांड" : "AI Tools Universe",
      subject: "Library",
      icon: "🚀",
      desc: isHindi
        ? "लेखन, कोडिंग और निर्माण के लिए बेहतरीन एआई टूल्स खोजें!"
        : "Explore cool AI tools curated for writing, coding, and creating!",
      color: "from-sky-300 via-sky-400 to-indigo-500",
      shadow: "shadow-sky-200/50 border-sky-300",
      path: "/dashboard/tools",
    },
    {
      name: isHindi ? "साहसिक यात्रा मार्ग" : "Adventure Roadmap",
      subject: "Roadmap",
      icon: "🗺️",
      desc: isHindi
        ? "एआई सुपरपावर्स हासिल करने के लिए चरण-दर-चरण मिशन शुरू करें!"
        : "Embark on step-by-step missions to master AI superpowers!",
      color: "from-emerald-300 via-green-400 to-teal-600",
      shadow: "shadow-emerald-200/50 border-emerald-300",
      path: "/dashboard/student/roadmap",
    },
    {
      name: isHindi ? "प्रसिद्धि कक्ष" : "Hall of Fame",
      subject: "Leaderboard",
      icon: "🏆",
      desc: isHindi
        ? "लीडरबोर्ड पर चढ़ें, उच्च स्कोर बनाएं और दुर्लभ बैज अनलॉक करें!"
        : "Climb the leaderboard, beat high scores, and unlock rare badges!",
      color: "from-purple-300 via-purple-400 to-violet-500",
      shadow: "shadow-purple-200/50 border-purple-300",
      path: "/dashboard/scoreboard",
    },
    {
      name: isHindi ? "मिशन लॉग" : "Quest Logs",
      subject: "Submissions",
      icon: "📝",
      desc: isHindi
        ? "अपने सबमिट किए गए काम, अंक और शिक्षक की प्रतिक्रिया देखें!"
        : "View your submitted assignments, grades, and teacher feedback!",
      color: "from-cyan-300 via-cyan-400 to-blue-500",
      shadow: "shadow-cyan-200/50 border-cyan-300",
      path: "/dashboard/submissions",
    },
    {
      name: isHindi ? "मेरा अवतार" : "My Avatar",
      subject: "My Profile",
      icon: "🦸",
      desc: isHindi
        ? "अपना अवतार कस्टमाइज़ करें और अपने स्तर के लक्ष्यों को ट्रैक करें!"
        : "Customize your custom avatar and track your level milestones!",
      color: "from-rose-300 via-rose-400 to-red-500",
      shadow: "shadow-rose-200/50 border-rose-300",
  ...
  if (kidsMode) {
    return (
      <div
        className={
          "min-h-screen relative selection:bg-violet-300/40 pb-20 kids-mode " +
          gradeClass
        }
      >
          ...
          >
            <div className="flex flex-col sm:flex-row items-center gap-6 z-10">
              ...
              <div className="mascot-bubble max-w-md floating-element">
                ...
                <p className="text-sm font-bold text-gray-500 mt-1">
                  🤖 {userAvatar.name}:{" "}
                  <span className="text-[#7c3aed]">{mascotGreeting}</span>
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 flex-wrap sm:flex-nowrap z-10">
              ...
              >
                ...
                <span>
                  {isHindi ? "गुप्त कोड दर्ज करें" : "Enter Secret Code"}
                </span>
              </button>
          ...
          >
            <div className="flex justify-between items-center mb-3">
              ...
              <span className="text-xs font-black text-[#7c3aed]">
                {stats?.xp.toNextLevel ?? 100} XP{" "}
                {isHindi ? "बाकी है" : "to go!"}
              </span>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {kidsWorlds.map((world, idx) => (
                ...
                >
                  <div className="absolute top-2 right-2 text-7xl opacity-10 group-hover:scale-125 transition-transform select-none">
                    {world.icon}
                  </div>
                  <div>
                    <span className="text-4xl block mb-4 filter drop-shadow-md">
                      {world.icon}
                    </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-black text-gray-800">
                  {isHindi ? "मेरे सक्रिय मिशन" : "My Active Quests"}
                </h2>
              </div>
                ...
                {assignLoading ? (
                  ...
                  <div className="text-center py-10 space-y-3">
                    ...
                    <p className="font-bold text-gray-500">
                      {isHindi
                        ? "सारे मिशन पूरे! आप बहुत बढ़िया हैं!"
                        : "All catch up! You completed every quest!"}
                    </p>
                  </div>
                ) : (
            ...
            <div className="lg:col-span-4 space-y-4">
              <div className="flex items-center gap-3">
                <span className="text-2xl">🎯</span>
                <h2 className="text-xl font-black text-gray-800">
                  {isHindi ? "दैनिक चुनौती" : "Daily Challenge"}
                </h2>
              </div>

              <div
                className={`kids-card p-6 bg-gradient-to-br from-amber-50 to-amber-100 border-amber-200 relative overflow-hidden flex flex-col justify-between h-[300px] ${!challenge?.completed ? "pulse-border-accent" : ""}`}
              >
                ...
                <div>
                  ...
                  <h3
                    className={`text-lg font-black leading-snug ${challenge?.completed ? "text-gray-400 line-through" : "text-gray-800"}`}
                  >
                  ...
                  <p className="text-xs text-gray-500 font-bold mt-2 leading-relaxed">
                    {challenge?.completed
                      ? isHindi
                        ? '🎉 वोल्ट कहता है: "क्या बात है! शानदार जीत!"'
                        : '🎉 Volt Bot: "Incredible victory today! You did it!"'
                      : isHindi
                        ? '🤖 वोल्ट कहता है: "सुपर बोनस अर्जित करने के लिए इस चुनौती को पार करें!"'
                        : '🤖 Volt Bot: "Conquer this challenge and claim your golden bonus!"'}
                  </p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="kids-card p-6 bg-white">
              <h3 className="font-black text-lg text-gray-800 mb-4 flex items-center gap-2">
                <span>🤖</span>{" "}
                {isHindi ? "त्वरित एआई टूल्स" : "Quick AI Tools"}
              </h3>
              {!tools || tools.length === 0 ? (
                <EmptyState
                  ...
                  message={
                    isHindi
                      ? "कोई टूल उपलब्ध नहीं है"
                      : "No magical tools active"
                  }
                />
              ) : (
                  ...
                  {quickTools.map((tool) => (
                    ...
                    >
                      <div
                        ...
                        style={{
                          backgroundColor: tool.brandColor || "#7c3aed",
                        }}
                      >
                        {tool.name[0]}
                      </div>
            ...
            <div className="fixed inset-0 bg-black/50 backdrop-blur-md z-50 flex items-center justify-center p-4">
              ...
              >
                ...
                <h3 className="text-xl font-black text-gray-800">
                  {isHindi
                    ? "एक नए Quest ग्रुप में शामिल हों!"
                    : "Join a Quest Group!"}
                </h3>
                <p className="text-sm font-bold text-gray-400 mt-2">
                  {isHindi
                    ? "अपने शिक्षक द्वारा दिया गया 6-अक्षर का गुप्त कोड दर्ज करें"
                    : "Enter the 6-character secret code from your teacher"}
                </p>
            ...
            >
              ...
              >
                ...
                <div className="space-y-2">
                  <h2 className="font-black text-5xl text-white tracking-tight drop-shadow-md">
                    LEVEL UP!
                  </h2>
                  <p className="text-2xl text-white font-extrabold drop-shadow-sm">
                    {isHindi
                      ? `आप स्तर ${showLevelUp} पर पहुंच गए हैं!`
                      : `You reached Level ${showLevelUp}!`}
                  </p>
                  <p className="text-sm text-yellow-900 font-bold leading-relaxed">
                    {isHindi
                      ? "अद्भुत काम किया! नए एआई टूल्स का उपयोग करना और खजाने को जीतना जारी रखें।"
                      : "Outstanding job! Keep exploring magical AI tools to rise to the top."}
                  </p>
                </div>
                <button
                  onClick={() => {
  ...
  return (
    <div
      className={`min-h-screen relative selection:bg-accent/30 ${gradeClass}`}
    >
      ...
      <div className="max-w-7xl mx-auto space-y-8 pb-24 lg:pb-12 px-4 md:px-8 pt-8 relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-foreground-subtle mt-1 flex items-center gap-1.5 flex-wrap">
                <span>
                  {userAvatar.name} {isHindi ? "कहता है:" : "says:"}
                </span>
                <span className="text-accent-light font-bold">
                  "
                  {isHindi ? "अरे! चलो एआई सीखते हैं!" : "Hey! Let's learn AI!"}
                  "
                </span>
                ...
                <span className="text-foreground-muted">
                  {isHindi ? "कक्षा" : "Grade"}{" "}
                  {stats?.user?.gradeLevel ?? gradeLevel}
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 flex-wrap md:flex-nowrap relative z-20">
            ...
            <div className="flex items-center gap-4 bg-surface/30 backdrop-blur-xl border border-white/5 px-5 py-3 rounded-2xl shadow-xl h-14">
              ...
              <div>
                <p className="text-[10px] text-foreground-subtle font-medium uppercase tracking-wider mb-0.5">
                  {isHindi ? "वर्तमान स्तर" : "Current Level"}
                </p>
        ...
        >
              ...
              >
                <div className="flex justify-between text-xs font-medium text-foreground-muted mb-3 select-none">
                  ...
                  <span className="group-hover:text-accent-light transition-colors">
                    {stats?.xp.toNextLevel ?? 100}{" "}
                    {isHindi
                      ? "एक्सपी शेष (देखने के लिए क्लिक करें!)"
                      : "XP remaining (Click to view!)"}
                  </span>
                </div>
                {statsLoading ? (
                ...
                <AnimatePresence>
                  {showXpTooltip && (
                    ...
                    >
                      🏆{" "}
                      {isHindi
                        ? `आप स्तर ${stats?.xp.level ? stats.xp.level + 1 : 2} से ${stats?.xp.toNextLevel ?? 100} एक्सपी दूर हैं!`
          ...
          <motion.div variants={itemVariants} className="md:col-span-4">
            <GlassCard
              className={`h-full relative overflow-hidden group ${!challenge?.completed ? "pulse-border-accent" : ""}`}
            >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-[10px] font-bold uppercase tracking-widest text-foreground-subtle">
                      {isHindi ? "आज का मिशन" : "Today's Mission"}
                    </p>
                    {challenge?.completed ? (
                      <span className="text-[10px] font-bold text-success">
                        {isHindi ? "✓ मिशन पूरा हुआ!" : "✓ Mission Complete!"}
                      </span>
                    ) : (
              ...
              {challengeLoading ? (
                ...
                <div className="relative z-10">
                  <h3
                    className={`text-base font-bold mb-1.5 leading-tight ${challenge?.completed ? "text-foreground-muted line-through" : "text-foreground"}`}
                  >
                  ...
                  <p className="text-xs text-foreground-subtle leading-relaxed mb-4">
                    {challenge?.completed
                      ? isHindi
                        ? '🎉 वोल्ट रोबोट कहता है: "आज कमाल का काम किया! आप अजेय हैं!"'
                        : '🎉 Volt Robot says: "Amazing work today! You\'re unstoppable!"'
                      : isHindi
                        ? '🤖 वोल्ट रोबोट कहता है: "दैनिक एक्सपी बोनस अर्जित करने के लिए इस मिशन को पूरा करें!"'
          ...
          >
            <GlassCard className="flex items-center gap-4 relative overflow-hidden group h-full">
              <div className="absolute -right-4 -bottom-4 text-6xl opacity-10 group-hover:scale-110 transition-transform duration-300 select-none">
                🏆
              </div>
          ...
          <motion.div variants={itemVariants} className="md:col-span-8">
            <GlassCard className="h-full">
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-base font-medium text-foreground tracking-wide">
                    {isHindi ? "सक्रिय असाइनमेंट" : "Active Assignments"}
                  </h2>
                </div>
                <a
              ...
              {assignLoading ? (
                ...
                <EmptyState
                  icon={
                    <CheckCircle2 className="w-6 h-6 text-foreground-subtle" />
                  }
                  message={
                    isHindi
                      ? "सब पूरा हो गया। कोई लंबित असाइनमेंट नहीं।"
                ...
                <div className="space-y-2">
                  {activeAssignments.map((a) => (
                    <AssignmentRow
                      key={a.id}
                      assignment={a}
                      daysUntilDue={getDaysUntilDue(a.dueDate)}
                    />
                  ))}
                </div>
              )}
              ...
              <GlassCard className="h-full">
                <div className="flex items-center justify-between mb-5">
                  <div className="flex items-center gap-3">
                    <BookOpen className="w-5 h-5 text-foreground-muted" />
                    <h2 className="text-base font-medium text-foreground tracking-wide">
                      {isHindi ? "मेरी कक्षाएं" : "My Classes"}
                    </h2>
                  </div>
                </div>
                ...
                {!stats?.classes || stats.classes.length === 0 ? (
                  <EmptyState
                    ...
                    message={
                      isHindi
                        ? "आप अभी तक किसी भी कक्षा में शामिल नहीं हुए हैं।"
              ...
              <GlassCard className="h-full">
                <div className="flex items-center justify-between mb-5">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-base font-medium text-foreground tracking-wide">
                      {isHindi ? "त्वरित टूल्स" : "Quick Tools"}
                    </h2>
                  </div>
                </div>
                ...
                {!tools || tools.length === 0 ? (
                  <EmptyState
                    icon={
                      <LayoutGrid className="w-5 h-5 text-foreground-subtle" />
                    }
                    message={
                      isHindi
                        ? "अभी तक किसी टूल का उपयोग नहीं किया गया।"
                  ...
                  {recentActivity.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-6 text-center">
                      ...
                      <p className="text-xs font-medium text-foreground-subtle">
                        {isHindi
                          ? "कोई हाल की गतिविधि लॉग नहीं की गई।"
                    ...
                    recentActivity.map((item, i) => (
                      <div
                        key={item.id || i}
                        className="flex items-start justify-between group cursor-default"
                      >
                        <div>
            ...
            >
              ...
              <div className="text-center space-y-2 mb-6">
                ...
                <p className="text-sm text-foreground-subtle">
                  Enter the 6-character class code (OTP) provided by your
                  teacher
                </p>
              </div>
        ...
        {showLevelUp !== null && (
          ...
          >
            ...
            >
              ...
              <div className="space-y-2">
                <h2 className="text-gradient font-display text-4xl font-extrabold tracking-tight">
                  {isHindi ? "स्तर बढ़ा!" : "LEVEL UP!"}
                </h2>
                ...
                <p className="text-sm text-foreground-subtle leading-relaxed">
                  {isHindi
                    ? "उत्कृष्ट कार्य! शीर्ष पर पहुंचने के लिए एआई टूल्स का उपयोग करना और असाइनमेंट पूरा करना जारी रखें।"
...
function MiniStat({
  ...
  return (
    <GlassCard className="!p-5 flex items-center gap-4">
      ...
      <div>
        <p className="text-xs font-medium text-foreground-subtle uppercase tracking-wider mb-1">
          {title}
        </p>
...
function AssignmentRow({
  ...
  return (
    <a
      ...
      className="group flex flex-col sm:flex-row sm:items-center justify-between p-4 -mx-4 rounded-2xl hover:bg-white/5 transition-colors duration-300 gap-4"
    >
      <div className="min-w-0 flex-1">
        ...
        <div className="flex items-center gap-3">
          ...
          <span
            className={`text-[11px] font-medium ${isUrgent ? "text-error/90" : "text-foreground-subtle"}`}
          >
            {daysUntilDue === 0
              ? isHindi
                ? "आज देय"
...
function ToolSquare({ tool }: { tool: any }) {
  return (
    <a
      ...
      className="group aspect-square rounded-2xl border border-white/5 bg-white/[0.02] hover:bg-white/5 flex flex-col items-center justify-center gap-3 transition-all duration-300 hover:border-white/10 relative overflow-hidden"
    >
