...
export default function StudentDashboardPage() {
  ...
  const kidsWorlds = [
    { name: isHindi ? "कक्षा के मिशन" : "Classroom Quests", subject: "Missions", icon: "🏫", desc: isHindi ? "होमवर्क पूरा करें, काम सबमिट करें और शिक्षकों से XP अर्जित करें!" : "Complete assignments, submit work, and earn XP from teachers!", color: "from-amber-300 via-yellow-400 to-orange-500", shadow: "shadow-amber-200/50 border-amber-300", path: "/dashboard/classroom" },
    { name: isHindi ? "एआई टूल्स ब्रह्मांड" : "AI Tools Universe", subject: "Library", icon: "🚀", desc: isHindi ? "लेखन, कोडिंग और निर्माण के लिए बेहतरीन एआई टूल्स खोजें!" : "Explore cool AI tools curated for writing, coding, and creating!", color: "from-sky-300 via-sky-400 to-indigo-500", shadow: "shadow-sky-200/50 border-sky-300", path: "/dashboard/tools" },
    { name: isHindi ? "साहसिक यात्रा मार्ग" : "Adventure Roadmap", subject: "Roadmap", icon: "🗺️", desc: isHindi ? "एआई सुपरपावर्स हासिल करने के लिए चरण-दर-चरण मिशन शुरू करें!" : "Embark on step-by-step missions to master AI superpowers!", color: "from-emerald-300 via-green-400 to-teal-600", shadow: "shadow-emerald-200/50 border-emerald-300", path: "/dashboard/student/roadmap" },
    { name: isHindi ? "प्रसिद्धि कक्ष" : "Hall of Fame", subject: "Leaderboard", icon: "🏆", desc: isHindi ? "लीडरबोर्ड पर चढ़ें, उच्च स्कोर बनाएं और दुर्लभ बैज अनलॉक करें!" : "Climb the leaderboard, beat high scores, and unlock rare badges!", color: "from-purple-300 via-purple-400 to-violet-500", shadow: "shadow-purple-200/50 border-purple-300", path: "/dashboard/scoreboard" },
    { name: isHindi ? "मिशन लॉग" : "Quest Logs", subject: "Submissions", icon: "📝", desc: isHindi ? "अपने सबमिट किए गए काम, अंक और शिक्षक की प्रतिक्रिया देखें!" : "View your submitted assignments, grades, and teacher feedback!", color: "from-cyan-300 via-cyan-400 to-blue-500", shadow: "shadow-cyan-200/50 border-cyan-300", path: "/dashboard/submissions" },
    { name: isHindi ? "हीरो प्रोफाइल" : "Hero Profile", subject: "My Profile", icon: "🦸", desc: isHindi ? "अपना अवतार कस्टमाइज़ करें और अपने स्तर के लक्ष्यों को ट्रैक करें!" : "Customize your custom avatar and track your level milestones!", color: "from-rose-300 via-rose-400 to-red-500", shadow: "shadow-rose-200/50 border-rose-300", path: "/dashboard/profile" }
  ];
