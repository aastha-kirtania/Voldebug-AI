...
export default function StudentDashboardPage() {
  ...
  const kidsWorlds = [
    ...
    { name: isHindi ? "मेरा अवतार" : "My Avatar", subject: "My Profile", icon: "🦸", desc: isHindi ? "अपना अवतार कस्टमाइज़ करें और अपने स्तर के लक्ष्यों को ट्रैक करें!" : "Customize your custom avatar and track your level milestones!", color: "from-rose-300 via-rose-400 to-red-500", shadow: "shadow-rose-200/50 border-rose-300", path: "/dashboard/profile" }
  ];
