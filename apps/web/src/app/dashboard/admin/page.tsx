      ...
      <div className="max-w-6xl mx-auto space-y-6 pb-24 lg:pb-8 px-4 md:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="font-display text-xl font-bold">
            {isHindi ? "प्रशासक डैशबोर्ड" : "Admin Dashboard"}
          </h1>
        </motion.div>
          ...
          <div className="card p-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-foreground-subtle">
                    {isHindi ? "कुल सदस्य" : "Total Members"}
                  </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-foreground-subtle">
                    {isHindi ? "कुल कक्षाएं" : "Total Classes"}
                  </p>
        ...
        <div className="card p-5">
          <h2 className="font-display text-lg font-semibold mb-4">
            {isHindi
              ? "प्रबंधन और सुरक्षा नियंत्रण"
              : "Management & Safety Controls"}
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <AdminLink
              ...
              description={
                isHindi
                  ? "स्कूल-व्यापी KPI, शिक्षक गिनती, और कक्षा मेट्रिक्स"
                  : "Access school-wide KPIs, teacher count, and class metrics"
              }
            />
            <AdminLink
              href="/dashboard/principal/audit-logs"
              label={isHindi ? "CBSE अनुपालन ऑडिट" : "CBSE Compliance Audits"}
              description={
                isHindi
                  ? "AI इंटरैक्शन ऑडिट करें, प्रॉम्प्ट फ़िल्टर करें, सुरक्षा लॉग जाँचें"
                  : "Audit AI interactions, filter prompts, check safety logs"
              }
            />
            <div className="p-4 rounded-xl border border-white/5 bg-white/[0.01] opacity-70">
              <p className="text-sm font-medium text-foreground-muted flex items-center gap-1.5">
                <span>
                  {isHindi ? "सिस्टम संरचना" : "System Configurations"}
                </span>
                <span className="text-[9px] px-1.5 py-0.5 rounded-full bg-accent/15 text-accent-light border border-accent/20">
                  DB Seeded
                </span>
              </p>
              <p className="text-xs text-foreground-subtle mt-1">
                {isHindi
                  ? "कक्षा आकार और पैरामीटर माइग्रेशन प्रीसेट्स द्वारा प्रबंधित होते हैं।"
                  : "Class sizes and parameters are managed via migration presets."}
              </p>
            </div>
          </div>
        </div>
...
function StatCard({
  ...
  return (
    <div className="card p-4">
      <div
        className={`inline-flex items-center justify-center w-9 h-9 rounded-lg ${iconBg} ${iconColor} mb-3`}
      >
        {icon}
      </div>
