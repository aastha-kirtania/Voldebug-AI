      ...
      <div className="card p-8 md:p-10 shadow-2xl relative overflow-hidden w-full max-w-2xl">
        ...
        <div className="space-y-6 text-sm text-foreground-muted leading-relaxed">
          <section>
            ...
            <p>
              By accessing and using the Voldebug AI Education Portal
          ...
          <section>
            ...
            <p>
              ...
              confidentiality of your account credentials. Students under 13
              must obtain parental consent before using the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You agree to use the Service only for educational purposes. You
              will not use the Service to generate, distribute, or promote
              harmful, illegal, or inappropriate content. Teachers are
              responsible for monitoring their students' use of the provided AI
              tools.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              functionality, is owned by Voldebug and is protected by
          ...
          <section>
            ...
            <p>
              Voldebug provides the Service "as is" without any warranties. We
