        ...
        <div className="space-y-6 text-sm text-foreground-muted leading-relaxed">
          <section>
            ...
            <p>
              ...
              an account, such as your name, email address, and role (Student or
              Teacher). We also automatically collect certain information about
              your device and how you interact with our Services, including your
          ...
          <section>
            ...
            <p>
              ...
              improve our educational platform. This includes operating the
              gamification system, tracking progress on assignments, and
              personalizing the learning experience. We do not sell your
          ...
          <section>
            <h2 className="text-foreground font-semibold text-base mb-2">
              3. Student Privacy (FERPA & COPPA)
            </h2>
            <p>
              We are committed to protecting student privacy and complying with
              all applicable educational privacy laws, including FERPA and
              COPPA. Data associated with student accounts is used solely for
              educational purposes and is only shared with authorized educators
              associated with the student's class.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              correct, or delete your personal information. Teachers and parents
              can request access to or deletion of their students' or children's
