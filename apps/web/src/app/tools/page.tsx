...
const ALL_TOOLS = [
  ...
  },
  {
    ...
    category: "CHAT_AI",
    description:
      "Google's multimodal AI for text, images and code across all subjects.",
    brandColor: "#4285F4",
    useCases: ["Multimodal Q&A", "Image understanding", "Coding"],
    usageCount: 9200,
  },
  {
    id: "12",
    ...
    category: "CODE_AI",
    description:
      "Free AI coding assistant with support for 70+ languages and editors.",
    brandColor: "#09B6A2",
    useCases: ["Autocomplete", "Refactoring", "Documentation"],
    usageCount: 3800,
  },
  {
    id: "13",
    ...
    category: "IMAGE_AI",
    description:
      "Adobe's generative AI for images, vectors, and design assets.",
    brandColor: "#FF0000",
    useCases: ["Generative fill", "Text to image", "Recolor"],
    usageCount: 4100,
  },
  {
    id: "14",
    ...
    category: "WRITING_AI",
    description:
      "AI-powered rewriting tool that improves clarity, tone, and style.",
    brandColor: "#6C5CE7",
    useCases: ["Rewriting", "Tone adjustment", "Summarizing"],
    usageCount: 2900,
  },
  {
    id: "15",
    ...
    category: "RESEARCH_AI",
    description:
      "Search and extract findings from 200M+ scientific papers using AI.",
    brandColor: "#3B82F6",
    useCases: ["Literature review", "Fact-checking", "Evidence finding"],
    usageCount: 1800,
  },
  {
    id: "16",
    ...
    category: "CHAT_AI",
    description:
      "Open-weights AI model with strong reasoning and multilingual capabilities.",
    brandColor: "#FF7000",
    useCases: ["Reasoning", "Multilingual", "Summarization"],
    usageCount: 2200,
  },
  {
    id: "17",
    ...
    category: "CODE_AI",
    description:
      "AI code completion for teams with privacy and IDE integration focus.",
    brandColor: "#5B5EA6",
    useCases: ["Team coding", "Code completion", "Privacy"],
    usageCount: 1600,
  },
  {
    id: "18",
    ...
    category: "IMAGE_AI",
    description:
      "OpenAI's image generation model with precise prompt following.",
    brandColor: "#10a37f",
    useCases: ["Illustrations", "Concept art", "Presentations"],
    usageCount: 5200,
  },
  {
    id: "19",
    ...
    category: "WRITING_AI",
    description:
      "AI writing platform for long-form content, marketing copy, and reports.",
    brandColor: "#FF6B35",
    useCases: ["Long-form writing", "Marketing", "Reports"],
    usageCount: 3300,
  },
  {
    id: "20",
    ...
    category: "RESEARCH_AI",
    description: "Free AI-powered search engine for scientific literature.",
    brandColor: "#1D3557",
    useCases: ["Academic search", "Citation graph", "Paper summaries"],
    usageCount: 2100,
  },
];
    ...
    >
      ...
      <div className="flex flex-wrap gap-1.5">
        {tool.useCases.slice(0, 2).map((uc) => (
          <span
            key={uc}
            className="text-[10px] px-2 py-0.5 rounded-md bg-surface text-foreground-muted border border-card-border"
          >
            {uc}
          </span>
        ))}
  ...
  return (
    ...
    >
      ...
      <div className="filter blur-[3px] pointer-events-none">
        ...
        <p className="text-xs text-foreground-muted leading-relaxed line-clamp-2 mt-4">
          {tool.description}
        </p>
      ...
      <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6 px-8 py-7">
        <div className="text-center sm:text-left">
          ...
          <p className="text-sm text-foreground-muted max-w-sm">
            Create a free account to access the full AI tools library, track
            your usage, and get personalized recommendations.
          </p>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 h-14 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-bold text-sm tracking-tight text-foreground">
            ...
            <span className="text-foreground-subtle text-xs ml-1 font-normal">
              AI
            </span>
          </span>
        </Link>
    ...
    fetch(`${apiUrl}/v1/tools`)
      ...
      .then((json) => {
        if (Array.isArray(json?.data) && json.data.length > 0)
          setApiTools(json.data);
      })
      .catch(() => {
        /* fall through to static demo list */
      });
  }, []);

  const baseTools: ToolItem[] = (
    apiTools && apiTools.length > 0 ? apiTools : ALL_TOOLS
  ) as ToolItem[];
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 pt-10 pb-4 relative z-10">
        ...
        >
          ...
          <p className="text-base text-foreground-muted max-w-lg mx-auto">
            Discover and master {baseTools.length} curated AI tools tailored for
            school assignments and creative learning.
          </p>
        ...
        <motion.div
          ...
          style={{
            background: "linear-gradient(to bottom, #fefdf8 70%, transparent)",
          }}
        >
        ...
        {filtered.length === 0 ? (
          ...
          >
            ...
            <p className="font-semibold text-foreground-muted mb-1">
              No tools found
            </p>
