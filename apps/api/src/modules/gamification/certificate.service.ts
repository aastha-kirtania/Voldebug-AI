...
export async function generateCertificatePdf(
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        .moveTo(width - 26, height - 46)
        .lineTo(width - 46, height - 26)
        .stroke(primaryColor);
      ...
      doc
        ...
        .fillColor(textColor)
        .text(
          "for outstanding academic success and milestone completion on Voldebug AI,",
          { align: "center" },
        );
      ...
      doc
        ...
        .fontSize(10)
        .fillColor(textColor)
        .text(data.dateEarned, 80, startY, {
          width: columnWidth,
          align: "center",
        });
      doc
      ...
      doc
        ...
        .fontSize(9)
        .fillColor(lightGray)
        .text("DATE OF ACHIEVEMENT", 80, startY + 20, {
          width: columnWidth,
          align: "center",
        });
      ...
      doc
        .circle(emblemCenter, startY + 10, 24)
        .fillOpacity(0.08)
      ...
      doc
        ...
        .fontSize(10)
        .fillColor(textColor)
        .text("Ms. Rivera & Education Team", rightColumnX, startY, {
          width: columnWidth,
          align: "center",
        });
      doc
        .moveTo(rightColumnX, startY + 15)
      ...
      doc
        ...
        .fontSize(9)
        .fillColor(lightGray)
        .text("AUTHORIZED SIGNATURE", rightColumnX, startY + 20, {
          width: columnWidth,
          align: "center",
        });
      ...
      doc
        ...
        .fontSize(8)
        .fillColor(lightGray)
        .text(`Verification ID: ${data.verificationId}`, 40, height - 55, {
          align: "left",
        });
